...
namespace Scripts.Transformation
{
    public class TransformationCamera : MonoBehaviour
    {
        ...
        public void Initialize(Transformation transformation, TransformationTransition transition, Camera.StereoscopicEye eye)
        {
            ...
            _transformationRenderer = transformation.Renderer;
            _transformationRenderer.material.SetTexture(_eye == Camera.StereoscopicEye.Left ? LeftRenderTexture : RightRenderTexture, _camera.targetTexture);
